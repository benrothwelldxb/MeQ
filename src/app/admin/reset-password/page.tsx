  ...
  if (!token) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
        ...
        <Link href="/admin/forgot-password" className="block mt-4 text-sm text-meq-sky hover:underline">Request a new one</Link>
      </div>
    );
  }
  ...
  if (state?.success) {
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
        ...
        <Link href="/admin/login" className="block mt-4 text-sm font-medium text-meq-sky hover:underline">Sign in</Link>
      </div>
    );
  }
