    ...
    <div className="max-w-md">
      ...
      <form action={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <fieldset className="space-y-2">
          ...
          <label className="flex items-center gap-3">
            <input type="checkbox" id="magt" name="magt" defaultChecked={student.magt} className="w-4 h-4 rounded border-gray-300 text-meq-sky focus:ring-meq-sky" />
            <span className="text-sm text-gray-700">MAGT <span className="text-gray-400">— More Able, Gifted &amp; Talented</span></span>
          </label>
          <label className="flex items-center gap-3">
            <input type="checkbox" id="eal" name="eal" defaultChecked={student.eal} className="w-4 h-4 rounded border-gray-300 text-meq-sky focus:ring-meq-sky" />
