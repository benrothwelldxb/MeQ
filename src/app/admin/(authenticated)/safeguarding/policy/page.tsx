...
export default async function SafeguardingDocsPage() {
  ...
  return (
    <div className="max-w-3xl">
      <Link href="/admin/safeguarding" className="text-sm text-meq-sky hover:underline">
        &larr; Back to Safeguarding
      </Link>
      <h1 className="text-2xl font-bold text-gray-900 mt-2 mb-1">Safeguarding policy</h1>
